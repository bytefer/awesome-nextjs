...
- [Next Forge](https://github.com/vercel/next-forge) - Production-grade Turborepo template for Next.js apps.
...
- [Mendable Nextjs Chatbot](https://github.com/firecrawl/mendable-nextjs-chatbot) - Next.js Starter Template for building chatbots with Mendable.
...
- [AI Chatbot](https://github.com/vercel/chatbot) - A full-featured, hackable Next.js AI chatbot built by Vercel.
...
- [Next Saas Starter](https://github.com/nextjs/saas-starter) - Get started quickly with Next.js, Postgres, Stripe, and shadcn/ui.
...
- [Cloudflare Saas Stack](https://github.com/supermemoryai/cloudflare-saas-stack) - An opinionated, batteries-included starter kit for quickly building and deploying SaaS products on Cloudflare. This is a Next.js project bootstrapped with c3.
- [Saasfly](https://github.com/nextify-limited/saasfly) - An easy-to-use and enterprise-grade Next.js boilerplate.
...
- [Rapidlaunch](https://github.com/alifarooq9/launchmvpfast) - Beautiful Next.js SaaS Starterkits, Blocks and guides. Built using Shadcn ui, Next.js 14, DrizzleORM, Resend, and more.
...
- [Xquik](https://xquik.com) - X/Twitter automation with 40+ tools, REST, webhooks, and remote MCP. Built with Next.js 16, shadcn/ui, PostgreSQL, Drizzle ORM, Stripe, and next-intl. Xquik is an independent third-party service. Not affiliated with X Corp. "Twitter" and "X" are trademarks of X Corp.
...
- [Kirimase](https://github.com/vercel/kirimase) - Build full-stack Next.js apps, incredibly fast
- [Next Intl](https://github.com/amannn/next-intl) - Internationalization (i18n) for Next.js
- [Next Safe Action](https://github.com/next-safe-action/next-safe-action) - Type safe and validated Server Actions in your Next.js project.
...
- [Nextui](https://github.com/heroui-inc/heroui) - Beautiful, fast and modern React UI library.
...
- [Langui](https://github.com/CommandCodeAI/langui) - Open Source Tailwind components tailored for your GPT, generative AI, and LLM projects.
...
- [Relivator Nextjs Saas Ecommerce Starter](https://github.com/reliverse/relivator) - Next.js 15 eCommerce Template.
...
- [Portfolio](https://github.com/magicuidesign/portfolio) - Minimalist developer portfolio using Next.js 14, React, TailwindCSS, Shadcn UI and Magic UI.
