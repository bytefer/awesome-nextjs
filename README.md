...
- [CiteMe](https://citeme.app) - Academic citation generator built with Next.js 16. Searches 10+ databases and formats references in 60 curated CSL styles. Features App Router, Supabase auth, and Paddle billing.
